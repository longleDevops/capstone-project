...
export default function Survey() {
    ...
    <tbody>
        <tr>
            <td>When did you graduate from CWU?</td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>What was your major at CWU?</td>
        </tr>
        <tr>
            <td>
                <select value={major} onChange={(e) => setMajor(e.target.value)}>
                    ...
                    {/* List of majors */}
                        ...
                        <button disabled={!graduationQuarter || !graduationYear || !major} onClick={handleNext}>Next</button>
                    </div>
                );
                case 2:
                    return (
