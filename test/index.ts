...
async function main() {
  ...
  // await insertDomesticOnly(15000);
  // await insertInternationalOnly(12000);
  // await insertWorkingOnly(8000);
  // await insertSeekingDegreeOnly(8000);
  // await insertSearchingJobOnly(10000);
}
